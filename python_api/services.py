...
def _default_model_profiles() -> list[dict[str, Any]]:
    ...
    profiles = [
        ...
        {
            "id": "profile-local-llama31-8b",
            "name": "Llama 3.1 8B Local",
            "provider": "local",
            "model": "unsloth/Meta-Llama-3.1-8B-Instruct",
            "category": "large",
            "description": "Stronger 8B Llama 3.1 instruct profile for higher answer quality on a single ~12 GB+ VRAM GPU with QLoRA.",
            "createdAt": now,
            "updatedAt": now,
        },
        {
            "id": "profile-local-qwen-14b",
            "name": "Qwen 2.5 14B Local",
            "provider": "local",
            "model": "Qwen/Qwen2.5-14B-Instruct",
            "category": "large",
            "description": "High-quality 14B Qwen profile for serious local QLoRA runs (recommended ~16 GB+ VRAM in 4-bit).",
            "createdAt": now,
            "updatedAt": now,
        },
        {
            "id": "profile-local-qwen-32b",
            "name": "Qwen 2.5 32B Local",
            "provider": "local",
            "model": "Qwen/Qwen2.5-32B-Instruct",
            "category": "large",
            "description": "Heavy-duty 32B Qwen profile for maximum local accuracy. Needs roughly 24 GB+ VRAM with QLoRA + offload.",
            "createdAt": now,
            "updatedAt": now,
        },
        {
        ...
        {
            "id": "profile-hf-qwen-14b",
            "name": "Qwen 2.5 14B SFT",
            "provider": "huggingface",
            "model": "Qwen/Qwen2.5-14B-Instruct",
            "category": "large",
            "description": "Paid cloud fine-tune of Qwen 2.5 14B for stronger quality without using local VRAM.",
            "createdAt": now,
            "updatedAt": now,
        },
        {
            "id": "profile-hf-qwen-32b",
            "name": "Qwen 2.5 32B SFT",
            "provider": "huggingface",
            "model": "Qwen/Qwen2.5-32B-Instruct",
            "category": "large",
            "description": "Paid cloud fine-tune of Qwen 2.5 32B for the highest open-weights accuracy when local GPUs are too small.",
            "createdAt": now,
            "updatedAt": now,
        },
