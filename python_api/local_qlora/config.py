...
LOCAL_TRAINING_PRESET_DEFAULTS: dict[str, dict[str, Any]] = {
    "fast": {
        ...
        "warmup_ratio": 0.05,
        "weight_decay": 0.01,
        "target_module_strategy": "attention_mlp",
        "eval_max_samples": 3,
        "eval_max_new_tokens": 128,
        "inference_temperature": 0.2,
        "inference_top_p": 0.9,
        "inference_top_k": 40,
        "inference_repeat_penalty": 1.08,
    },
    "balanced": {
        "num_train_epochs": 3,
        "per_device_train_batch_size": 2,
        ...
        "warmup_ratio": 0.08,
        "weight_decay": 0.02,
        "target_module_strategy": "auto",
        "eval_max_samples": 6,
        "eval_max_new_tokens": 160,
        "inference_temperature": 0.18,
        "inference_top_p": 0.88,
        "inference_top_k": 40,
    ...
    "quality": {
        ...
        "warmup_ratio": 0.1,
        "weight_decay": 0.02,
        "target_module_strategy": "expanded",
        "eval_max_samples": 8,
